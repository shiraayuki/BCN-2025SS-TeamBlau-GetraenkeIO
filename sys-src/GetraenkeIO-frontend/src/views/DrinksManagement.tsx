        ...
        <Container maxWidth="xl" sx={{ mt: 4, px: 4 }}>
            ...
            <Dialog open={openDialog} onClose={handleCloseDialog}>
                ...
                <DialogContent sx={{ display: 'flex', flexDirection: 'column', gap: 2, mt: 1, minWidth: 400 }}>
                    <TextField label="Name" value={form.name} margin='dense' onChange={(e) => setForm({ ...form, name: e.target.value })} />
                    <TextField label="Preis (€)" type="number" value={form.cost} onChange={(e) => setForm({ ...form, cost: e.target.value })} />
                    <TextField label="Vorrat" type="number" value={form.count} onChange={(e) => setForm({ ...form, count: e.target.value })} />
                    <TextField label="Bild-URL" value={form.imageUrl} onChange={(e) => setForm({ ...form, imageUrl: e.target.value })} />
                </DialogContent>
                <DialogActions>
