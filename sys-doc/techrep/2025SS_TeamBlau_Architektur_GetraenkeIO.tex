...
Die Kommunikation mit dieser findet ausschließlich über das SQLModel-Framework statt. Das Datenmodell wurde ebenfalls von SQLModel auf Basis von den im Python-Code erzeugten Datenklassen erstellt.
